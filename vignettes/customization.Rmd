...
vignette: >
  %\VignetteIndexEntry{Customizing Cards}
...
cardargus uses Google Fonts by default. The default font is "Jost", but you can use any Google Font:
